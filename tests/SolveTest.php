...
class SolveTest extends \PHPUnit_Framework_TestCase
{
	private $solve;
  ...
  */
	public function 問題の答え($path, $expected)
	{
		$result = $this->solve->run($path);
  ...
  * @test
	* @dataProvider pathProvider
  */
	public function ルートの確認($path, $expected)
	{
		$result = $this->solve->getRoute($path);
